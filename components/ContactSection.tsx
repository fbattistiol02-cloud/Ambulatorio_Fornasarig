          ...
          <div className="lg:col-span-6">
            <Reveal>
              ...
              <p className="mt-7 max-w-[32rem] text-lg leading-[1.7] text-ink/80">
                {site.availability} Scrivi su WhatsApp per informazioni
                e per concordare giorno e orario della visita.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.1}>
              <a
                ...
                className="whatsapp-cta mt-8 w-full sm:w-auto"
              >
                <WhatsAppIcon className="size-5 shrink-0 text-whatsapp-bright" />
                Scrivi su WhatsApp
              </a>

              <p className="mt-3 text-sm text-muted">Per informazioni e appuntamenti.</p>
            </Reveal>
          </div>
