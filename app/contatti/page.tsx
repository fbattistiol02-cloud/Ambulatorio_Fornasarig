...
export default function Contatti() {
  return (
    <>
      ...
      <section className="bg-surface py-16 lg:py-24" aria-labelledby="scrivere">
        <div className="wrap">
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-6">
              <Reveal>
                <p className="eyebrow text-action">Come si prenota</p>
                <h2
                  id="scrivere"
                ...
                <div className="border-t border-line-soft">
                  <div className="flex gap-4 border-b border-line-soft py-6">
                    ...
                    <div>
                      ...
                      <p className="mt-1.5 font-serif text-xl leading-snug text-heading">
                        {site.address.street}
                      </p>
                  ...
                  <div className="flex gap-4 border-b border-line-soft py-6">
                    ...
                    <div className="min-w-0">
                      ...
                      <a
                        ...
                        className="mt-0.5 block break-words py-2 text-[1.0625rem] text-heading underline decoration-line underline-offset-4 transition-colors hover:text-action hover:decoration-action/40"
                      >
                        {site.email.label}
                      </a>
                    </div>
                  ...
                  <div className="border-b border-line-soft py-6">
                    <a
                      ...
                      className="inline-flex min-h-11 items-center gap-2.5 rounded-sm px-4 py-2.5 text-[0.9375rem] font-medium text-action ring-1 ring-inset ring-action transition-colors hover:bg-action/5 hover:ring-action-hover"
                    >
                  ...
                  <div className="flex gap-5 py-6">
                    ...
                    <div>
                      ...
                      <p className="mt-1.5 max-w-[18rem] text-[0.9375rem] leading-[1.65] text-muted">
      ...
      {/* Dove si trova. */}
      <section className="bg-surface-alt py-16 lg:py-24" aria-labelledby="dove">
        <div className="wrap">
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-5">
              <Reveal>
                <p className="eyebrow text-action">Dove siamo</p>
                <h2
                  id="dove"
                  className="mt-6 text-[1.875rem] leading-[1.2] text-heading sm:text-[2.25rem]"
                >
              ...
              <Reveal delay={0.14}>
                <div className="mt-10 border-t border-line pt-6">
                  ...
                  <ul className="mt-3 flex flex-wrap gap-x-2 gap-y-1 text-[0.9375rem] text-muted">
                    {nearbyTowns.map((comune, indice) => (
                      <li key={comune}>
                        {comune}
                        {indice < nearbyTowns.length - 1 ? (
                          <span aria-hidden className="ml-2 text-action/50">
                            ·
                          </span>
                        ) : null}
                      </li>
            ...
            <div className="lg:col-span-6 lg:col-start-7">
              <Reveal delay={0.12}>
                <div className="rounded-sm bg-surface p-5 ring-1 ring-inset ring-line sm:p-7">
                  <MappaPercoto />
                </div>
              </Reveal>
            </div>
      ...
      <section
        data-contact-end
        className="bg-surface-blue py-14 text-heading lg:py-16"
        ...
        <div className="wrap">
          <Reveal>
            <div className="grid gap-8 lg:grid-cols-12 lg:gap-16">
              <div className="lg:col-span-5">
                <p className="eyebrow text-action">Urgenze</p>
                <h2
                  id="urgenze"
                  className="mt-5 text-[1.5rem] leading-[1.25] text-heading sm:text-[1.875rem]"
                >
                  Fuori orario.
                </h2>
              </div>
